...
<head>
    ...
    <link type='text/css' media='all' href="<?php echo $base_path ?>static/css/main.d7c1e26f.chunk.css" rel="stylesheet">
</head>
<body>
...
<script type="text/javascript" src="<?php echo $base_path ?>static/js/main.bd2d3fe2.chunk.js"></script>
</html>